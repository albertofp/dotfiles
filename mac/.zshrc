...
alias zshconfig="nvim ~/dotfiles/mac/.zshrc"
alias tmuxconfig="nvim ~/dotfiles/mac/.tmux.conf"
...
alias sync="ANSIBLE_PYTHON_INTERPRETER=auto_silent ansible-playbook ~/dotfiles/mac/ansible/playbooks/bootstrap.yaml --connection=local --inventory=localhost, --forks=10"
